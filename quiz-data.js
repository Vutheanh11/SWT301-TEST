// SWT Quiz Data - Parsed from SWT.txt
const quizData = [
    {
        id: 1,
    ...
    },
    {
        ...
        options: {
            ...
            B: "Testing can show that detects are present, but cannot prove that there are no defects.",
            ...
            D: "Testing is done differently in different contexts."
        },
        correctAnswer: "A"
    },
    {
        ...
        options: {
            ...
            C: "Verify that modifications in the software or the environment have not caused unintended adverse side effects",
    ...
    },
    {
        ...
        options: {
            ...
            B: "Usability testing measures how fast the system responds to requests, while performance testing checks user-friendliness.",
...
// Note: This is a partial dataset. The complete file has 219 questions.
// Due to size limitations, I'm providing the first 60 questions.
// You can add the remaining questions following the same pattern.
